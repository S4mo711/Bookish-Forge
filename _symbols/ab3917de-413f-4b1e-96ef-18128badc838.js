// Testimonials 1 - Updated February 15, 2025
function noop() { }
const identity = x => x;
...
// (124:4) {#if testimonials.length > 1}
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button0, "class", "svelte-nhwkfg");
			...
			attr(button1, "class", "svelte-nhwkfg");
			attr(div, "class", "controls svelte-nhwkfg");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			aside = claim_element(body_nodes, "ASIDE", { class: true });
		...
		h() {
			attr(h2, "class", "heading svelte-nhwkfg");
			attr(div, "class", "testimonial svelte-nhwkfg");
			attr(aside, "class", "section-container svelte-nhwkfg");
			attr(body, "class", "svelte-nhwkfg");
		},
		m(target, anchor) {
			insert_hydration(target, body, anchor);
			append_hydration(body, aside);
