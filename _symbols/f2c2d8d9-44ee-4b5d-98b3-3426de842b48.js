// Accordion - Updated February 15, 2025
function noop() { }
const identity = x => x;
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(div, "class", "description svelte-1fsxora");
		},
		m(target, anchor) {
...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		h() {
			attr(span0, "class", "svelte-1fsxora");
			attr(div0, "class", "title svelte-1fsxora");
			attr(span1, "class", "icon svelte-1fsxora");
			attr(button, "class", "svelte-1fsxora");
			attr(div2, "class", "item svelte-1fsxora");
			toggle_class(div2, "active", /*activeItem*/ ctx[2] === /*i*/ ctx[8]);
			this.first = div2;
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "heading svelte-1fsxora");
			attr(div, "class", "accordion svelte-1fsxora");
			attr(section, "class", "section-container svelte-1fsxora");
			attr(body, "class", "svelte-1fsxora");
		},
		m(target, anchor) {
